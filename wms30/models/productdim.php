...
class ProductDim extends CI_Model {
    
    private static $mainTable         = 'ProductDim';
    private static $mainKey           = 'product_dim_id';
    private static $parentTable       = 'Products';
    private static $parentKey         = 'product_id';
    private static $class             = 'ProductDim';
    private static $select            = 'Product Dimension';
