...
<div class="modal modal-form" id="new-feature">
	...
	<br>
	<h1 class="modalcustom">Submit a feature</h1>
		...
		<div>
			<?= form_fieldset('Info') ?>
				<p>
					...
					<?= form_dropdown('priority', $priorities, '2'); ?>
				</p>
				<p>
					<?php
						$types = array(
					...
					<?= form_dropdown('type', $types, '0'); ?>
				</p>
				<p>
					<?= form_label('Link (ie. shipping/take/-1)', 'link'); ?><br>
					<?= form_input('link', set_value('link')); ?>
				</p>
				<p>
					<?php
						$status = array(
